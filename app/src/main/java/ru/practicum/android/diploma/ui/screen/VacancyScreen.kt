    ...
    Scaffold(
        ...
        Column(
            ...
            when (state) {
                ...
                VacancyDetailsScreenState.Loading, VacancyDetailsScreenState.Default -> LoadingComponent()
                else -> Placeholder(
                    R.drawable.error_alt_placeholder,
                    stringResource(R.string.details_error)
                )
            }
        }
    }
